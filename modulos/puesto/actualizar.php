...
<html>
<head>
	<script src="../../js/validaciones/validarPuesto.js"></script>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form  data-parsley-validate class="form-horizontal form-label-left" name="frmDatos" id="frmDatos" method="POST" action="procesar/update.php">
										<input type="hidden" name="txtId" value="<?php echo $puesto->getIdPuesto(); ?>">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nombre <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="txtLugar" required="required" class="form-control" name="txtLugar" value="<?php echo $puesto->getLugar(); ?>">
											</div>
										</div>
