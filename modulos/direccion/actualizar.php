								...
								<div class="x_content">
									...
									<form  data-parsley-validate class="form-horizontal form-label-left" name="frmDatos" id="frmDatos" method="POST" action="procesar/update.php">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="txtCalle" name="txtCalle" required="required" class="form-control" value="<?php echo $direccion->getCalle(); ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" id="txtNumero" required="required" class="form-control" name="txtNumero" value="<?php echo $direccion->getNumero(); ?>">
											</div>
										</div>
