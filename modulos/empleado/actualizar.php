							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form  data-parsley-validate class="form-horizontal form-label-left" name="frmDatos" id="frmDatos" method="POST" action="procesar/update.php">
										<input type="hidden" name="txtId" value="<?php echo $empleado->getEmpleado(); ?>">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="nombre">Nombre <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" required="required" class="form-control" name="txtNombre" id="txtNombre" value="<?php echo $empleado->getNombre(); ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" required="required" class="form-control" name="txtApellido" id="txtApellido" value="<?php echo $empleado->getApellido(); ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" required="required" class="form-control" name="txtDni" id="txtDni" maxlength="8" value="<?php echo $empleado->getDni(); ?>">
											</div>
										</div>
										<div class="item form-group">
